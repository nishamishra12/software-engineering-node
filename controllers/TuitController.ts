...
export default class TuitController implements TuitControllerI {
    ...
    public static getInstance = (app: Express): TuitController => {
        if(TuitController.tuitController === null) {
            ...
            //for Testing
            app.get("/api/tuits/tuit/:tuitString/delete",
                TuitController.tuitController.deleteTuitByTuitDescription);
        }
    ...
    deleteTuitByTuitDescription = (req: Request, res: Response) =>
        TuitController.tuitDao.deleteTuitByTuitDescription(req.params.tuitString)
            .then(status => res.send(status));
};
